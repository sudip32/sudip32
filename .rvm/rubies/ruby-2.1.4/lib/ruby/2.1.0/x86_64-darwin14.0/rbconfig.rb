...
module RbConfig
  RUBY_VERSION == "2.1.4" or
    raise "ruby lib version (2.1.4) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "1"
  CONFIG["TEENY"] = "0"
  CONFIG["PATCHLEVEL"] = "265"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/CloudFactory/.rvm/rubies/ruby-2.1.4")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/CloudFactory/.rvm/rubies/ruby-2.1.4' '' '--with-opt-dir=/usr/local/opt/libyaml:/usr/local/opt/readline:/usr/local/opt/libksba:/usr/local/opt/openssl' '--disable-install-doc' '--enable-shared' 'build_alias=' 'host_alias=' 'target_alias=' 'CC=gcc'"
  ...
  CONFIG["arch"] = "x86_64-darwin14.0"
  CONFIG["sitearchincludedir"] = "$(includedir)/$(sitearch)"
  CONFIG["archincludedir"] = "$(includedir)/$(arch)"
  CONFIG["sitearchlibdir"] = "$(libdir)/$(sitearch)"
  CONFIG["archlibdir"] = "$(libdir)/$(arch)"
  CONFIG["libdirname"] = "libdir"
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/CloudFactory/.rvm/rubies/ruby-2.1.4"
  ...
  CONFIG["RUBY_RELEASE_DATE"] = "2014-10-27"
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.1.4"
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = ""
  CONFIG["build_alias"] = ""
